...
public class TestClass {
	...
	public void setUp() throws Exception 
	{
		Map<String,Customer> data= new HashMap<String, Customer>();
		 Customer cust1=new Customer("Ravi", "9490406126",new Wallet(new BigDecimal(9000)));
	...
	{
		service.createAccount("Ravi", "94904061266", new BigDecimal(9000));
	}

	@Test
	public void testCreateAccount7() 
	{
		Customer actual=service.createAccount("Teja", "9666570195", new BigDecimal(5000));
		Customer expected=new Customer("Teja", "9666570195", new Wallet(new BigDecimal(5000)));
	...
	{
		Customer actual=service.createAccount("Chinni", "8754922472", new BigDecimal(0));
		Customer expected=new Customer("Chinni", "8754922472", new Wallet(new BigDecimal(0)));
	...
	{
		Customer actual=service.createAccount("Chinni", "8754922472", new BigDecimal(5000.75));
		Customer expected=new Customer("Chinni", "8754922472", new Wallet(new BigDecimal(5000.75)));
